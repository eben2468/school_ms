        ...
        <main class="p-6 lg:p-8 flex-1">
            <div class="w-full">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-3xl font-semibold text-gray-900 dark:text-white">Saved Reports</h1>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                    <div class="p-6">
                        <div class="text-center py-12">
                            <i class="fas fa-save text-gray-400 dark:text-gray-500 text-6xl mb-4"></i>
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Saved Reports</h3>
                            <p class="text-gray-500 dark:text-gray-400 mb-4">Access previously saved and generated reports</p>
                            <div class="space-y-4">
