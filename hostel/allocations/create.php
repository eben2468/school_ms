...
$breadcrumbs = [
    ['title' => 'Dashboard', 'url' => '../../dashboard.php'], ['title' => 'Hostel', 'url' => '../index.php'], ['title' => 'Allocations', 'url' => 'index.php'], ['title' => 'Create Allocation']
];
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
                    <div class="p-6">
                        <div class="text-center py-12">
                            <i class="fas fa-user-plus text-gray-400 dark:text-gray-500 text-6xl mb-4"></i>
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Create Room Allocation</h3>
                            <p class="text-gray-500 dark:text-gray-400 mb-4">Allocate a room to a student</p>
                            <div class="space-y-4">
